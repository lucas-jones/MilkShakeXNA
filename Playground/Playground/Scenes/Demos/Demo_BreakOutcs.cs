...
namespace Samples.Scenes.Demos
{
    public class Demo_BreakOut : DemoScene
    {
        ...
        {
            AddNode(new Sprite(GenerateTexureWithBorder(200, 30, Color.Red, 3, Color.Pink)));
        }
        ...
        private Texture2D GenerateTexureWithBorder(int width, int height, Color color, int borderThickness, Color borderColor)
        {
            Texture2D texture = new Texture2D(MilkShake.Graphics, width, height);
